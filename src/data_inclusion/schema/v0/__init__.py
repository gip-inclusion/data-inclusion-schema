from data_inclusion.schema.v0.common import (
    CodeCommune,
    CodeDepartement,
    CodeEPCI,
    CodePostal,
...
from data_inclusion.schema.v0.services import Service
from data_inclusion.schema.v0.structures import Structure
