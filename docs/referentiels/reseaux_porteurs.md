...
| `departements` | Départements et Services Départementaux | Les Conseils Départementaux (CD), les Maisons Départementales pour les Personnes Handicapées (MDPH), les Maisons Départementales des solidarité (MDS), les Unions Départementales des Associations Familiales (UDAF), les Centres Départementaux d’Action Sociale (CDAS), etc. |
...
| `nqt` | Association NQT | - |
| `pimms-mediation` | Point Information Médiation Multi Services | - |
